  ...
  @endif
			<div class="col-md-8 col-md-offset-2">
				<div class="panel panel-default">
					<div class="panel-heading">View Client Order Form</div>
					<div class="panel-body">
		 					 <ul class="nav nav-tabs">
							  <li name="1" class="active"><a href="/orders">Client</a></li>
							  <li name="1"><a href="/orders/driver">Driver</a></li>
							</ul>
							<br /> 
							...
							<tr>
								<td style='white-space: pre-wrap;'>{{ $order->adID }}</td>
								<td style='white-space: pre-wrap;'>{{ $order->datetimeDelivery }}</td>
								<td>{{ $order->description }}</td>
							<td style='white-space: pre-wrap;'><a href="job/{{ $order->adID }}/user/{{ $order->userWantsJob }}">View</a></td>
							</tr>
							@endforeach
